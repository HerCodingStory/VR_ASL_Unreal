	...
	: Super(ObjectInitializer)
{
	...
	//Thumb
	Bones[(int32)EBodyStateBasicBoneType::BONE_HAND_WRIST_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_THUMB_0_METACARPAL_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_THUMB_0_METACARPAL_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_THUMB_1_PROXIMAL_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_THUMB_1_PROXIMAL_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_THUMB_2_DISTAL_L]);

	//Index
	Bones[(int32)EBodyStateBasicBoneType::BONE_HAND_WRIST_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_0_METACARPAL_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_0_METACARPAL_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_1_PROXIMAL_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_1_PROXIMAL_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_2_INTERMEDIATE_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_2_INTERMEDIATE_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_3_DISTAL_L]);

	//Middle
	Bones[(int32)EBodyStateBasicBoneType::BONE_HAND_WRIST_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_0_METACARPAL_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_0_METACARPAL_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_1_PROXIMAL_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_1_PROXIMAL_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_2_INTERMEDIATE_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_2_INTERMEDIATE_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_3_DISTAL_L]);

	//Ring
	Bones[(int32)EBodyStateBasicBoneType::BONE_HAND_WRIST_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_RING_0_METACARPAL_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_RING_0_METACARPAL_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_RING_1_PROXIMAL_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_RING_1_PROXIMAL_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_RING_2_INTERMEDIATE_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_RING_2_INTERMEDIATE_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_RING_3_DISTAL_L]);

	//Pinky	
	Bones[(int32)EBodyStateBasicBoneType::BONE_HAND_WRIST_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_PINKY_0_METACARPAL_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_PINKY_0_METACARPAL_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_PINKY_1_PROXIMAL_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_PINKY_1_PROXIMAL_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_PINKY_2_INTERMEDIATE_L]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_PINKY_2_INTERMEDIATE_L]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_PINKY_3_DISTAL_L]);
	...
	//Thumb
	Bones[(int32)EBodyStateBasicBoneType::BONE_HAND_WRIST_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_THUMB_0_METACARPAL_R]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_THUMB_0_METACARPAL_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_THUMB_1_PROXIMAL_R]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_THUMB_1_PROXIMAL_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_THUMB_2_DISTAL_R]);
	
	//Index
	Bones[(int32)EBodyStateBasicBoneType::BONE_HAND_WRIST_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_0_METACARPAL_R]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_0_METACARPAL_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_1_PROXIMAL_R]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_1_PROXIMAL_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_2_INTERMEDIATE_R]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_2_INTERMEDIATE_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_INDEX_3_DISTAL_R]);

	//Middle
	Bones[(int32)EBodyStateBasicBoneType::BONE_HAND_WRIST_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_0_METACARPAL_R]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_0_METACARPAL_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_1_PROXIMAL_R]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_1_PROXIMAL_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_2_INTERMEDIATE_R]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_2_INTERMEDIATE_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_MIDDLE_3_DISTAL_R]);

	//Ring
	Bones[(int32)EBodyStateBasicBoneType::BONE_HAND_WRIST_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_RING_0_METACARPAL_R]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_RING_0_METACARPAL_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_RING_1_PROXIMAL_R]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_RING_1_PROXIMAL_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_RING_2_INTERMEDIATE_R]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_RING_2_INTERMEDIATE_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_RING_3_DISTAL_R]);

	//Pinky	
	Bones[(int32)EBodyStateBasicBoneType::BONE_HAND_WRIST_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_PINKY_0_METACARPAL_R]);
	Bones[(int32)EBodyStateBasicBoneType::BONE_PINKY_0_METACARPAL_R]->AddChild(Bones[(int32)EBodyStateBasicBoneType::BONE_PINKY_1_PROXIMAL_R]);
...
UBodyStateArm* UBodyStateSkeleton::LeftArm()
{
	if (!PrivateLeftArm)
	{
		...
		PrivateLeftArm->Hand->Palm = Bones[(int32)EBodyStateBasicBoneType::BONE_HAND_WRIST_L];	//this should have some offset from wrist...
		...
		ThumbFinger->Intermediate = Bones[(int32)EBodyStateBasicBoneType::BONE_THUMB_2_DISTAL_L];	//set intermediate to distal too for thumb
...
UBodyStateArm* UBodyStateSkeleton::RightArm()
{
	if (!PrivateRightArm)
	{
		...
		PrivateRightArm->Hand->Palm = Bones[(int32)EBodyStateBasicBoneType::BONE_HAND_WRIST_R];	//this should have some offset from wrist...
		...
		ThumbFinger->Intermediate = Bones[(int32)EBodyStateBasicBoneType::BONE_THUMB_2_DISTAL_R];	//set intermediate to distal too for thumb
